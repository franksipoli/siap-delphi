object FRM_A007: TFRM_A007
  ...
  object LMDGroupBox3: TLMDGroupBox
    ...
    object DED_NIDTBXCOR: TDBEdit
      ...
      Color = 15727354
      DataField = 'NIDTBXCOR'
      DataSource = DTM_A007.DTS_020
      ReadOnly = True
      TabOrder = 0
    end
    object DED_CNOMECOR: TDBEdit
      Left = 61
      Top = 28
      Width = 489
      Height = 21
    ...
    object GRD_CORACA: TDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'CNOMECOR'
          Title.Caption = 'Descrição Cor/Raça'
          Width = 426
          Visible = True
        end>
    end
