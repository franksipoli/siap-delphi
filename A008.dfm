object FRM_A008: TFRM_A008
  ...
  object LMDGroupBox3: TLMDGroupBox
    ...
    Caption = '  Cadastro de Nacionalidade '
    ...
    object Label1: TLabel
      ...
      Width = 124
      Height = 13
      Caption = '  Descrição Nacionalidade '
    end
    ...
    object DED_NIDTBXNAC: TDBEdit
      ...
      Color = 15727354
      DataField = 'NIDTBXNAC'
      DataSource = DTM_A008.DTS_023
      ReadOnly = True
      TabOrder = 0
    end
    object DED_CNOMENAC: TDBEdit
      Left = 61
      Top = 28
      Width = 489
      Height = 21
  ...
  object LMDGroupBox2: TLMDGroupBox
    ...
    Bevel.ShadowColor = clSilver
    Bevel.StandardStyle = lsFrameInset
    Caption = ' Lista de Nacionalidade '
    CaptionFont.Charset = ANSI_CHARSET
    CaptionFont.Color = clWindowText
    CaptionFont.Height = -11
    CaptionFont.Name = 'Tahoma'
    ...
    object GRD_NAC: TDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'CNOMENAC'
          Title.Caption = 'Descrição Nacionalidade'
          Width = 441
          Visible = True
        end>
    end
