object FRM_A012: TFRM_A012
  ...
  object LMDGroupBox3: TLMDGroupBox
    ...
    Caption = '  Cadastro de Orgão Emissor '
    ...
    object Label1: TLabel
      ...
      Width = 142
      Height = 13
      Caption = '  Descrição do Orgão Emissor '
    end
    object DED_NIDTBXERG: TDBEdit
      Left = 11
      Top = 28
      Width = 49
      Height = 21
      Color = 15727354
      DataField = 'NIDTBXERG'
      DataSource = DTM_A012.DTS_024
      ReadOnly = True
      TabOrder = 0
    end
    object DED_CNOMEEMIRG: TDBEdit
      Left = 61
      Top = 28
      Width = 489
      Height = 21
      DataField = 'CNOMEEMIRG'
      DataSource = DTM_A012.DTS_024
      TabOrder = 1
    end
  end
  object LMDGroupBox2: TLMDGroupBox
    ...
    Bevel.ShadowColor = clSilver
    Bevel.StandardStyle = lsFrameInset
    Caption = '  Lista de Orgões Emissores '
    CaptionFont.Charset = ANSI_CHARSET
    CaptionFont.Color = clWindowText
    CaptionFont.Height = -11
    CaptionFont.Name = 'Tahoma'
    ...
    object GRD_ERG: TDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Title.Caption = 'Descrição do Oragão Emissor'
          Width = 441
          Visible = True
        end>
    end
