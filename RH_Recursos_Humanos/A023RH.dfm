object FRM_A023RH: TFRM_A023RH
  ...
  object LMDGroupBox2: TLMDGroupBox
    ...
    object DBG_TBXCAT: TDBGrid
      ...
      TitleFont.Style = []
      OnMouseUp = DBG_TBXCATMouseUp
      Columns = <
        item
          Expanded = False
          FieldName = 'CDESCRICAT'
          Title.Caption = ' Descrição da Classe de Atividade'
          Width = 446
          Visible = True
        end
        item
  ...
  object LMDGroupBox3: TLMDGroupBox
    ...
    object Label21: TLabel
      ...
      Width = 164
      Height = 13
      Caption = '  Descrição da Classe de Atividade'
    end
    ...
    object DED_CDESCRICAT: TDBEdit
      Left = 9
      Top = 28
      Width = 477
      Height = 21
      CharCase = ecUpperCase
      DataField = 'CDESCRICAT'
      DataSource = DTM_A023RH.DTS_126
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
