object FRM_A003RH: TFRM_A003RH
  ...
  object LMDGroupBox3: TLMDGroupBox
    ...
    Caption = '  Cadastro de Tipo de Salário Família '
    ...
    object Label1: TLabel
      ...
      Width = 178
      Height = 13
      Caption = '  Descrição do Tipo de Salario Família '
    end
    object Label3: TLabel
      ...
      Width = 64
      Height = 13
      Caption = '  Idade Limite'
    end
    object DED_CNOMEDSF: TDBEdit
      Left = 8
      Top = 28
      Width = 460
      Height = 21
      DataField = 'CNOMEDSF'
      DataSource = DTM_A003RH.DTS_028
      TabOrder = 0
    end
    object DED_NIDADE: TDBEdit
      Left = 468
      Top = 28
      Width = 83
      Height = 21
  ...
  object LMDGroupBox2: TLMDGroupBox
    ...
    Bevel.ShadowColor = clSilver
    Bevel.StandardStyle = lsFrameInset
    Caption = '  Lista de Tipos de Salário Família '
    CaptionFont.Charset = ANSI_CHARSET
    CaptionFont.Color = clWindowText
    CaptionFont.Height = -11
    CaptionFont.Name = 'Tahoma'
    ...
    object GRD_DSF: TDBGrid
      ...
      Columns = <
        item
          Expanded = False
          FieldName = 'CNOMEDSF'
          Title.Caption = 'Descrição do Tipo de Salário Família'
          Width = 423
          Visible = True
        end
        item
