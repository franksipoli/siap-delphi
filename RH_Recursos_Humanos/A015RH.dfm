object FRM_A015RH: TFRM_A015RH
  ...
  object Panel2: TPanel
    ...
    object BTN_Deptos: TSpeedButton
      Left = 2
      Top = 278
      Width = 32
      Height = 27
      Cursor = crHandPoint
      Hint = 'Departamentos do Orgão'
      Flat = True
      ParentShowHint = False
      ShowHint = True
      OnClick = BTN_DeptosClick
    end
    ...
    object BTN_UNIDADES: TSpeedButton
      Left = 2
      Top = 309
      Width = 32
      Height = 27
      Cursor = crHandPoint
      Hint = 'Unidades do Orgão'
      Flat = True
      ParentShowHint = False
      ShowHint = True
  ...
  object LMDGroupBox3: TLMDGroupBox
    ...
    object Label2: TLabel
      ...
      Width = 128
      Height = 13
      Caption = '  Funções de Governo - TC'
    end
    object DED_CDESCRIORG: TDBEdit
      Left = 9
      Top = 28
      Width = 256
      Height = 21
      CharCase = ecUpperCase
      DataField = 'CDESCRIORG'
      DataSource = DTM_A015RH.DTS_088
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object DBL_CFUNCAO: TRxDBLookupCombo
      ...
      LookupSource = DTM_A015RH.DTS_120
      TabOrder = 1
    end
  end
    ...
    object GRD_ORGAO: TDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Title.Caption = ' Funções de Governo - TC'
          Width = 257
          Visible = True
        end>
    end
