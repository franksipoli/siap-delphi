object FRM_A025RH: TFRM_A025RH
  Left = 114
  Top = 91
  Width = 623
  Height = 459
  BorderIcons = [biSystemMenu]
  Caption = ' Situação da Pessoa'
  Color = clSilver
  ...
  object LMDGroupBox2: TLMDGroupBox
    ...
    object DBG_TBXSPT: TDBGrid
      ...
      TitleFont.Style = []
      OnMouseUp = DBG_TBXSPTMouseUp
      Columns = <
        item
          Expanded = False
          FieldName = 'CDESCRSPT'
          Title.Caption = ' Descrição da Situação da Pessoa'
          Width = 446
          Visible = True
        end
        item
  ...
  object LMDGroupBox3: TLMDGroupBox
    ...
    object Label21: TLabel
      ...
      Width = 163
      Height = 13
      Caption = '  Descrição da Situação da Pessoa'
    end
