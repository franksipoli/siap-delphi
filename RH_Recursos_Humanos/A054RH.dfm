object FRM_A054RH: TFRM_A054RH
  Left = 199
  Top = 164
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = ' Dependente do Imposto de Renda para o Parentesco'
  ClientHeight = 228
  ClientWidth = 639
  Color = clSilver
  ...
  object GRB_IR: TLMDGroupBox
    ...
    object LMDPanelFill3: TLMDPanelFill
      ...
      object BTN_GIR: TSpeedButton
        Left = 200
        Top = 0
        Width = 19
        Height = 16
        Cursor = crHandPoint
        Hint = 'Incluir Dependente para Imposto de Renda'
        Flat = True
        Glyph.Data = {
    ...
    object DBG_DISP: TDBGrid
      ...
      Columns = <
        item
          Expanded = False
          FieldName = 'CNOMEDIR'
          Title.Caption = ' Dependente do Imposto de Renda'
          Width = 233
          Visible = True
        end>
    end
