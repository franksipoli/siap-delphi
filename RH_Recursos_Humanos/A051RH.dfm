object FRM_A051RH: TFRM_A051RH
  Left = 126
  Top = 155
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Unidade Contabil  do Orgão'
  ClientHeight = 300
  ClientWidth = 575
  Color = clSilver
    ...
    object DBG_DISP: TDBGrid
      ...
      Columns = <
        item
          ...
          Title.Caption = ' Descrição da Unidade'
          Width = 211
          Visible = True
        end>
    end
