object FRM_A019RH: TFRM_A019RH
  ...
  object LMDGroupBox3: TLMDGroupBox
    ...
    object DED_CDESCRISET: TDBEdit
      Left = 9
      Top = 28
      Width = 256
      Height = 21
      CharCase = ecUpperCase
      DataField = 'CDESCRISET'
      DataSource = DTM_A019RH.DTS_090
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object DBL_CFUNCAO: TRxDBLookupCombo
      ...
      LookupSource = DTM_A019RH.DTS_120
      TabOrder = 1
    end
  end
