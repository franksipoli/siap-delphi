object FRM_A024RH: TFRM_A024RH
  Left = 114
  Top = 91
  Width = 623
  Height = 459
  BorderIcons = [biSystemMenu]
  Caption = ' Tipo de Cargo TCE'
  Color = clSilver
  ...
  object LMDGroupBox2: TLMDGroupBox
    ...
    object DBG_TBXTCT: TDBGrid
      ...
      TitleFont.Style = []
      OnMouseUp = DBG_TBXTCTMouseUp
      Columns = <
        item
          Expanded = False
          FieldName = 'CDESCRITCT'
          Title.Caption = ' Descrição do Tipo de Cargo'
          Width = 446
          Visible = True
        end
        item
  ...
  object LMDGroupBox3: TLMDGroupBox
    ...
    object Label21: TLabel
      ...
      Width = 137
      Height = 13
      Caption = '  Descrição do Tipo de Cargo'
    end
    ...
    object DED_CDESCRITCT: TDBEdit
      Left = 9
      Top = 28
      Width = 477
      Height = 21
      CharCase = ecUpperCase
      DataField = 'CDESCRITCT'
      DataSource = DTM_A024RH.DTS_121
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
