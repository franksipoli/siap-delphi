object FRM_A002RH: TFRM_A002RH
  ...
  object LMDGroupBox3: TLMDGroupBox
    ...
    Caption = '  Cadastro de Tipo de Dependente para IR '
    ...
    object DED_CNOMEDIR: TDBEdit
      Left = 8
      Top = 28
      Width = 460
      Height = 21
      DataField = 'CNOMEDIR'
      DataSource = DTM_A002RH.DTS_027
      TabOrder = 0
    end
  ...
  object LMDGroupBox2: TLMDGroupBox
    ...
    Bevel.ShadowColor = clSilver
    Bevel.StandardStyle = lsFrameInset
    Caption = '    Lista de Tipo de Dependente para IR '
    CaptionFont.Charset = ANSI_CHARSET
    CaptionFont.Color = clWindowText
    CaptionFont.Height = -11
    CaptionFont.Name = 'Tahoma'
    ...
    object GRD_DIR: TDBGrid
      ...
      Columns = <
        item
          Expanded = False
          FieldName = 'CNOMEDIR'
          Title.Caption = 'Tipo de Dependente para IR'
          Width = 423
          Visible = True
        end
        item
