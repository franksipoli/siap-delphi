object FRM_A022RH: TFRM_A022RH
  ...
  object LMDGroupBox2: TLMDGroupBox
    ...
    object DBG_TBXFGV: TDBGrid
      ...
      TitleFont.Style = []
      OnMouseUp = DBG_TBXFGVMouseUp
      Columns = <
        item
          Expanded = False
          FieldName = 'CFUNCAO'
          Title.Caption = ' Descrição da Função'
          Width = 446
          Visible = True
        end
        item
