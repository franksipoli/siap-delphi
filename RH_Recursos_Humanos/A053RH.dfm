object FRM_A053RH: TFRM_A053RH
  Left = 211
  Top = 183
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = ' Dependente Salário Família para o Parentesco'
  ClientHeight = 228
  ClientWidth = 639
  Color = clSilver
  ...
  object GRB_GRP: TLMDGroupBox
    ...
    object LMDPanelFill3: TLMDPanelFill
      ...
      object BTN_DSF: TSpeedButton
        Left = 200
        Top = 0
        Width = 19
        Height = 16
        Cursor = crHandPoint
        Hint = 'Incluir Dependente para Salário Família'
        Flat = True
        Glyph.Data = {
    ...
    object DBG_DISP: TDBGrid
      ...
      Columns = <
        item
          Expanded = False
          FieldName = 'CNOMEDSF'
          Title.Caption = ' Dependente do Salário Família'
          Width = 233
          Visible = True
        end>
    end
