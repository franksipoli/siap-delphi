object DTM_A017ADPT: TDTM_A017ADPT
  ...
  object QRY_154: TOraQuery
    ...
    SQL.Strings = (
      ...
      '  tbxgtm.*,'
      '  tbxulc.cdescriulc,'
      '  tbxulc1.cdescriulc as dat_dest'
      'from'
      '  tbxgtm,'
      '  tbxulc,'
      '  tbxulc tbxulc1'
      'where'
      '  tbxgtm.cnroguia = :cnroguia and'
    ...
    object QRY_154CDESCRIULC: TStringField
      FieldName = 'CDESCRIULC'
      Size = 50
    end
    object QRY_154DAT_DEST: TStringField
      FieldName = 'DAT_DEST'
      Size = 50
    end
  end
  ...
  object QRY_152: TOraQuery
    ...
    CachedUpdates = True
    BeforeInsert = QRY_152BeforeInsert
