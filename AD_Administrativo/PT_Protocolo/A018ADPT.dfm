object FRM_A018ADPT: TFRM_A018ADPT
  Left = 207
  Top = 112
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = '  Arquivamento de Processos'
  ClientHeight = 496
  ClientWidth = 622
  Color = clSilver
  ...
  object LMDGroupBox2: TLMDGroupBox
    ...
    object LMDPanelFill3: TLMDPanelFill
      ...
      Caption = '  Protocolos não Concluidos'
    ...
    object DBG_DISP: TDBGrid
      ...
      Width = 264
      Height = 404
      DataSource = DTM_A018ADPT.DTS_151
    ...
    object DBG_AUT: TDBGrid
      ...
      Width = 263
      Height = 404
      DataSource = DTM_A018ADPT.DTS_151_1
      Options = [dgTitles, dgIndicator, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit, dgMultiSelect]
      TabOrder = 3
      TitleFont.Charset = ANSI_CHARSET
      TitleFont.Color = clWindowText
