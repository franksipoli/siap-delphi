object FRM_A011ADPT: TFRM_A011ADPT
  Left = 130
  Top = 72
  Width = 623
  Height = 459
  Caption = 'FRM_A011ADPT'
  Color = clSilver
  ...
  object Panel2: TPanel
    ...
    object BTN_IMPDOC: TSpeedButton
      Left = 2
      Top = 277
      Width = 32
      Height = 27
  ...
  object LMDGroupBox2: TLMDGroupBox
    ...
    Caption = '  Lista Tipos de Solicitação  '
    ...
    object GRD_ORGAOS: TDBGrid
      ...
      Height = 207
      Color = 15727354
      DataSource = DTM_A011ADPT.DTS_155
      FixedColor = clSilver
  ...
  object LMDGroupBox3: TLMDGroupBox
    ...
    object Label2: TLabel
      ...
      Width = 158
      Height = 13
      Caption = '  Descrição do Tipo de Solicitação'
    end
    ...
    object DBE_NDIASATEND: TDBEdit
      Left = 472
      Top = 29
      Width = 31
      Height = 21
      DataField = 'NDIASATEND'
      DataSource = DTM_A011ADPT.DTS_155
      TabOrder = 1
    end
    object DBC_CREFERENRH: TRxDBComboBox
      Left = 503
      Top = 29
      Width = 50
      Height = 21
      Style = csDropDownList
      DataField = 'CREFERENRH'
      DataSource = DTM_A011ADPT.DTS_155
      EnableValues = True
      ItemHeight = 13
      Items.Strings = (
  ...
  object DBP_DOCS: TppDBPipeline
    DataSource = DTM_A011ADPT.DTS_155_1
    UserName = 'DBP_DOCS'
    Left = 515
    Top = 323
  end
