...
uses MPLLib, DMCTRL, Login, Fundo, A001ADRA, A002ADRA, D001ADRA, MSenha,
  A001, D001, Auxil, A002, A003, D002, D003;
   ...
   begin
     ...
     if not bdForm  then
       begin
         ...
         if NomeForm = 'FRM_A001ADRA' then
           begin
             Application.CreateForm(TFRM_A001ADRA,FRM_A001ADRA);
             Application.CreateForm(TDTM_A001ADRA,DTM_A001ADRA);
           end;
         ...
         if NomeForm = 'FRM_A001' then
           begin
             Application.CreateForm(TFRM_A001,FRM_A001);
             Application.CreateForm(TDTM_A001,DTM_A001);
           end;
         if NomeForm = 'FRM_A002' then
           begin
             Application.CreateForm(TFRM_A002,FRM_A002);
             Application.CreateForm(TDTM_A002,DTM_A002);
           end;
         if NomeForm = 'FRM_A003' then
           begin
             Application.CreateForm(TFRM_A003,FRM_A003);
             Application.CreateForm(TDTM_A003,DTM_A003);
           end;
