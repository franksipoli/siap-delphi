object FRM_A004ADAT: TFRM_A004ADAT
  Left = 111
  Top = 89
  Width = 623
  Height = 459
  ...
  object LMDGroupBox3: TLMDGroupBox
    ...
    Caption = '  Cadastro de Veiculos de Publicação '
    ...
    object DED_NIDTBXVPB: TDBEdit
      Left = 10
      Top = 32
      Width = 60
      Height = 21
      DataField = 'NIDTBXVPB'
      DataSource = DTM_A004ADAT.DTS_072
      ReadOnly = True
      TabOrder = 0
    end
    object DED_CDESCRIVPB: TDBEdit
      Left = 71
      Top = 32
      Width = 480
      Height = 21
      DataField = 'CDESCRIVPB'
      DataSource = DTM_A004ADAT.DTS_072
      TabOrder = 1
    end
  end
  object LMDGroupBox2: TLMDGroupBox
    ...
    Bevel.ShadowColor = clSilver
    Bevel.StandardStyle = lsFrameInset
    Caption = ' Veiculos de Publicação '
    CaptionFont.Charset = ANSI_CHARSET
    CaptionFont.Color = clWindowText
    CaptionFont.Height = -11
    CaptionFont.Name = 'Tahoma'
