object FRM_A009: TFRM_A009
  ...
  object LMDGroupBox3: TLMDGroupBox
    ...
    Caption = '  Cadastro de Grau de Instrução '
    ...
    object Label1: TLabel
      ...
      Width = 160
      Height = 13
      Caption = '  Descrição do Grau de Instrução '
    end
    object DED_NIDTBXGRI: TDBEdit
      Left = 11
      Top = 28
      Width = 49
      Height = 21
      Color = 15727354
      DataField = 'NIDTBXGRI'
      DataSource = DTM_A009.DTS_022
      ReadOnly = True
      TabOrder = 0
    end
    object DED_CNOMEGRI: TDBEdit
      Left = 61
      Top = 28
      Width = 489
      Height = 21
  ...
  object LMDGroupBox2: TLMDGroupBox
    ...
    Bevel.ShadowColor = clSilver
    Bevel.StandardStyle = lsFrameInset
    Caption = '  Lista de Grau de Instrução '
    CaptionFont.Charset = ANSI_CHARSET
    CaptionFont.Color = clWindowText
    CaptionFont.Height = -11
    CaptionFont.Name = 'Tahoma'
