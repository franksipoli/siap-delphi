object FRM_A010UTCO: TFRM_A010UTCO
  Left = 92
  Top = 82
  ...
  object LMDGroupBox3: TLMDGroupBox
    ...
    Caption = '  Cadastro de Perfil Básico'
    ...
    object Label2: TLabel
      ...
      Width = 120
      Height = 13
      Caption = '  Descrição do Perfil Base'
    end
    object EDT_CSIGLAPER: TEdit
      Left = 11
      Top = 28
      Width = 63
      Height = 21
      ...
      ParentFont = False
      TabOrder = 0
      OnKeyPress = EDT_CSIGLAPERKeyPress
    end
    object DED_CNOMEPER: TDBEdit
      Left = 74
      Top = 28
      Width = 477
      Height = 21
      CharCase = ecUpperCase
      DataField = 'CNOMEPER'
      DataSource = DTM_A010UTCO.DTS_056
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object GRD_PERFIL: TDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'CNOMEPER'
          Title.Caption = 'Descrição do Perfil base'
          Width = 416
          Visible = True
        end>
    end
