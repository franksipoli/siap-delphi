            ...
            begin
              ...
              for i := 0 to  Fields.Count -1  do
                begin
                  ...
                  if oTabList2.Fields.Fields[i].FieldName = 'nidtbl_g' then
                    oTabList2.Fields.Fields[i].Value :=
                    DTM_A002UTCO.QRY_041.ParamByName('nidtbl_g').asInteger
          ...
          if DBG_APLIC2.SelectedRows.CurrentRowSelected then
            begin
              ...
              for i := 0 to  Fields.Count -1  do
                begin
                  {Passo o Grupo definido aneriormente}
                  if oTabList1.Fields.Fields[i].FieldName = 'nidtbl_g' then
